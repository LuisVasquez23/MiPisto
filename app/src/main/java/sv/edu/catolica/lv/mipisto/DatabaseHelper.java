...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE User (user_id INTEGER PRIMARY KEY AUTOINCREMENT, user_name VARCHAR(60), password VARCHAR(60), user_image BLOB, email VARCHAR(60));");
        db.execSQL("CREATE TABLE Categoria (category_id INTEGER PRIMARY KEY AUTOINCREMENT, category_name VARCHAR(60));");
